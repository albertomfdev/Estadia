              ...
              <div class="col-lg-4 "> <!-- TERCER COLUMNA-->
                   <div class="card" > 
                      <div class="row ">
                          ...
                          <div class="col">
                              <div class="card-body">
                                <h5 class="card-title">Metodología</h5>
                                <p class="card-text">La metodología seleccionada para el desarrollo de este proyecto de estadía es la Extreme Programming.</p>
                              </div>
                          </div>
                      </div>
                  </div>                    
